...
if selected == 'Diabetes Prediction':
    ...
    with col1:
        SkinThickness = st.text_input('Skin Thickness value (1.9-2.4 mm)')
...
if selected == 'Heart Disease Prediction':
    ...
    with col3:
        cp = st.text_input('Chest Pain types ( 0-No chest pain , 1-Typical heart-related chest pain , 2-less likely heart-related and 3-Chest pain not related to the heart.)')
